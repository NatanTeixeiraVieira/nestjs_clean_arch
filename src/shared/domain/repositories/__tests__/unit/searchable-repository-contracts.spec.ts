...
describe('Searchable repository', () => {
  describe('SearchParams tests', () => {
    ...
    it('should work perPage props', () => {
      ...
      params.forEach(({ perPage, expected }) => {
        expect(new SearchParams({ perPage: perPage as any }).perPage).toBe(
          expected,
        );
      });
    });

    it('should work sort props', () => {
      const sut = new SearchParams();
    ...
    it('should work sortDir props', () => {
      ...
      params.forEach(({ sortDir, expected }) => {
        expect(
          new SearchParams({ sort: 'field', sortDir: sortDir as any }).sortDir,
        ).toBe(expected);
      });
    });

    it('should work filter props', () => {
      const sut = new SearchParams();
  ...
  describe('SearchResult tests', () => {
    it('should work constructor props', () => {
