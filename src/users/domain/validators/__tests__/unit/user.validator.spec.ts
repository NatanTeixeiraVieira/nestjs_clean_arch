...
describe('UserValidator unit tests', () => {
  ...
  it('Should validate cases for user validator class', () => {
  ...
  describe('Name field', () => {
    it('Shouls invalidate cases for name field', () => {
  ...
  describe('Email field', () => {
    it('Shouls invalidate cases for email field', () => {
      let isValid = sut.validate(null);
      expect(isValid).toBeFalsy();
  ...
  describe('Password field', () => {
    it('Shouls invalidate cases for password field', () => {
      let isValid = sut.validate(null);
      expect(isValid).toBeFalsy();
  ...
  describe('CreatedAt field', () => {
    it('Shouls invalidate cases for createdAt field', () => {
